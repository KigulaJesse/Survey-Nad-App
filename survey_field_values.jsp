            ...
            <div class="row row-height">
                ...
                <!--============RIGHT CONTENT=============-->
                    <div class="col-lg-6" style="padding:10px;"id="start">
                            <div class = "row" style="padding:13em 0 1.5em 17em;"></br>
                                
                                <% 
                                    if(request.getParameter("survey_field_id") != null){ 
                                %>
                                        <a href="./survey_fields.jsp?name=<%=request.getParameter("survey")%>" style="position:relative; margin-right: 10px;" class="btn btn-danger">Back</a>
                                        <a href="./add_field_value.jsp?survey_field_id=<%=request.getParameter("survey_field_id")%>&amp;survey=<%=request.getParameter("survey")%>" class="btn btn-primary pull-right">Add Field Value</a> 
                                <% }else if(session.getAttribute("survey_field_id") != null){ %>
                                        <a href="./survey_fields.jsp?name=<%=session.getAttribute("survey")%>" style="position:relative; margin-right: 10px;" class="btn btn-danger">Back</a>
                                        <a href="./add_field_value.jsp?survey_field_id=<%=session.getAttribute("survey_field_id")%>&amp;survey=<%=session.getAttribute("survey")%>" class="btn btn-primary pull-right">Add Field Value</a> 
                                <% } %>
                            </div>                            
                            
                            <div class="row" style="padding:0 1.5em 1.5em 18em;">
                                <div class="col-m ">
                                    <div class="tile">
                                        <div class="tile-body">
