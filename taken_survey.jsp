                                            ...
                                            <div id="middle-wizard">
                                                <!--=====LOOP THROUGH SURVEY FIELS=========-->
                                                    ...
                                                    %>
                                                                    ...
                                                                    <div class="step">
                                                                        <h3 class="main_question">
                                                                            <strong>
                                                                                ...
                                                                                <a href="./survey_fields.jsp?name=<%=request.getParameter("survey_id") %>" style="position:relative; margin-left: 300px;" class="btn btn-danger">Back</a>
                                                                            </strong>
                                                            ...
                                                            <!--==========CHECK BOXES==========-->
                                                                ...
                                                                %>
                                                                    <div class="step">
                                                                        <h3 class="main_question"><strong><%= count%>/<%=total_survey_fields + 1%><a href="./survey_fields.jsp?name=<%=request.getParameter("survey_id") %>" style="position:relative; margin-left: 300px;" class="btn btn-danger">Back</a></strong><%= resultSet2.getString("field_description")%></h3>
                                                                        <% 
                                                                            while(resultSet3.next()){   
                                                                                statement5 = connection.createStatement();   
                                                                                String sql5 ="select * from take_survey_fields where survey_field_id = ";
                                                                        ...
                                                                        %>  
                                                                                        <div class="form-group rating_wp clearfix">
                                                                                            ...
                                                                                            <span class="rating">
                                                                                                ...
                                                                                                <input type="radio" class="rating-input" id="rating-input-<%=ratecount%>-5" name="<%= resultSet2.getString("id")%>_<%= resultSet3.getString("id")%>" value="5 Stars" disabled
                                                                                                    <% 
                                                                                                        statement5 = connection.createStatement();   
                                                                                                ...
                                                                                                <input type="radio" class="rating-input" id="rating-input-<%=ratecount%>-4" name="<%= resultSet2.getString("id")%>_<%= resultSet3.getString("id")%>" value="4 Stars" disabled
                                                                                                    <% statement5 = connection.createStatement();   
                                                                                                        sql5 ="select * from take_survey_fields where survey_field_id = ";
                                                                                                        sql5 = sql5 + resultSet2.getString("id") + " and take_survey_id =" + request.getParameter("taken_survey_id");
                                                                                                        resultSet5 = statement5.executeQuery(sql5);
                                                                                                ...
                                                                                                <input type="radio" class="rating-input" id="rating-input-<%=ratecount%>-3" name="<%= resultSet2.getString("id")%>_<%= resultSet3.getString("id")%>" value="3 Stars" disabled
                                                                                                    <% 
                                                                                                        statement5 = connection.createStatement();   
                                                                                                        sql5 ="select * from take_survey_fields where survey_field_id = ";
                                                                                                        sql5 = sql5 + resultSet2.getString("id") + " and take_survey_id =" + request.getParameter("taken_survey_id");
                                                                                                ...
                                                                                                <input type="radio" class="rating-input" id="rating-input-<%=ratecount%>-2"  name="<%= resultSet2.getString("id")%>_<%= resultSet3.getString("id")%>" value="2 Stars" disabled
                                                                                                    <% 
                                                                                                        statement5 = connection.createStatement();   
                                                                                                        sql5 ="select * from take_survey_fields where survey_field_id = ";
                                                                                                        sql5 = sql5 + resultSet2.getString("id") + " and take_survey_id =" + request.getParameter("taken_survey_id");
                                                                                                ...
                                                                                                <input type="radio" class="rating-input" id="rating-input-<%=ratecount%>-1"  name="<%= resultSet2.getString("id")%>_<%= resultSet3.getString("id")%>" value="1 Stars" disabled
                                                                                                    <% 
                                                                                                        statement5 = connection.createStatement();   
                                                                                                        sql5 ="select * from take_survey_fields where survey_field_id = ";
                                                                                                        sql5 = sql5 + resultSet2.getString("id") + " and take_survey_id =" + request.getParameter("taken_survey_id");
                                                ...
                                                <!--========SUBMIT STEP=======-->
                                                    <div class="submit step">
                                                        <h3 class="main_question"><strong></strong>Are You In Favour Of This Decision <a href="./survey_fields.jsp?name=<%=request.getParameter("survey_id") %>" style="position:relative; margin-left: 10px;" class="btn btn-danger">Back</a></h3>
                                                        <div class="form-group">
