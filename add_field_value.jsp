                    ...
                    <div id="wizard_container">
                        <div id="top-wizard">
                            ...
                            <form method="POST" action="./AddSurveyFieldValue">
                                ...
                                <input type = "hidden" name="survey" value = "<%=request.getParameter("survey")%>">
                                <!-- Leave for security protection, read docs for details -->
                                <div id="middle-wizard">
                                    <div class="submit step">
                                        <h3 class="main_question">Add Survey Field Value <a href="./survey_field_values.jsp?survey_field_id=<%=request.getParameter("survey_field_id") %>&amp;survey=<%=request.getParameter("survey")%>" style="position:relative; margin-left: 120px;" class="btn btn-danger">Back</a></h3>
